...
main.lbltitle.Caption = "SUB JOB NO LIST"
Me.Top = 10
Me.Left = 10
Option1.Value = False
Option2.Value = True
...
ls.Open "select Distinct(subjobno_code),subjobno_desc from subjobno order by subjobno_code", Cn, 3, 2
While Not ls.EOF
...
rs.Open "select * from subjobno where subjobno_code='" & nm(0) & "' order by subjobno_code", Cn, 3, 2
While Not rs.EOF
  cnt = cnt + 1 '********************************
                                If cnt >= 55 Then
...
fs.WriteLine "            <td  >" & rs!subjobno_code & "</td>"
If rs!subjobno_desc = "" Then
fs.WriteLine "            <td  >&nbsp;</td>"
Else
fs.WriteLine "            <td  >" & rs!subjobno_desc & "</td>"
End If
...
fs.WriteLine "           <td  ><b>SUBJOB LIST</td>"
...
fs.WriteLine "            <td Nowrap><font color=white>SubJob No</td>"
