...
Begin VB.Form estimatedincurredcost1 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "estimatedincurredcost1.frx":0000
         ...
         TabCaption(1)   =   "Notes"
         TabPicture(1)   =   "estimatedincurredcost1.frx":001C
   ...
   End
End
Attribute VB_Name = "estimatedincurredcost1"
...
cr2.Open "select * from resourcedetails where dresc_code='" & frm_estimatedcost.textresccode.Text & "' and dresc_proj='" & frm_estimatedcost.textprojkey.Text & "' and dresc_curcy='" & cbo_curr.Text & "' and dresc_year='" & frm_estimatedcost.cbo_year.Text & "'", Cn, 3, 2
If Not cr2.EOF Then
...
nj = Split(frm_estimatedcost.cbo_pproj.Text, "  -  ", Len(frm_estimatedcost.cbo_pproj.Text), vbTextCompare)

Dim fl As New ADODB.Recordset
If fl.State Then fl.Close
fl.Open "select * from resourcemaster rm, resourcedetails rd where rm.resc_code=rd.dresc_code and dresc_ratetype='BR' and resc_code='" & kl(0) & "' and rd.dresc_year='" & frm_estimatedcost.cbo_year.Text & "' and dresc_proj='" & nj(0) & "' ", Cn, 3, 2
        If Not fl.EOF Then
        frm_estimatedcost.textrescname.Text = fl!resc_desc
        frm_estimatedcost.textresccode.Text = fl!resc_code
        frm_estimatedcost.textprojkey.Text = nj(0)
        frm_estimatedcost.txt_projdesc.Text = nj(1)
        frm_estimatedcost.txt_brate.Text = Format(fl!dresc_rate, "###,###,##0.00")
        frm_estimatedcost.textcosttype.Text = "E"
        frm_estimatedcost.txt_vendor.Text = fl!resc_vendorcode
        frm_estimatedcost.txt_respcode.Text = fl!resc_respcode
        ...
        If Not rr.EOF Then
        frm_estimatedcost.txt_respname.Text = rr(0)
        End If
        frm_estimatedcost.Text3.Text = fl!dresc_curcy
...
Dim fl1 As New ADODB.Recordset
        ...
        fl1.Open "select * from resourcemaster rm, resourcedetails rd where rm.resc_code=rd.dresc_code and rd.dresc_ratetype='CR' and rm.resc_code='" & kl(0) & "' and rd.dresc_year='" & frm_estimatedcost.cbo_year.Text & "' and dresc_proj='" & nj(0) & "'", Cn, 3, 2
            If Not fl1.EOF Then
            frm_estimatedcost.txt_crate.Text = Format(fl1!dresc_rate, "###,###,##0.00")
            frm_estimatedcost.Text4.Text = fl1!dresc_curcy
            frm_estimatedcost.textresccode.Text = fl1!resc_code
            frm_estimatedcost.textprojkey.Text = nj(0)
            End If
        fl1.Close
...
spl1 = Split(frm_estimatedcost.cbo_resc.Text, "  -  ", Len(frm_estimatedcost.cbo_resc.Text), vbTextCompare)
cbo_type.Clear
...
nn = Split(frm_estimatedcost.cbo_resc.Text, "  -  ", Len(frm_estimatedcost.cbo_resc.Text), vbTextCompare)
nnm = Split(cbo_spread.Text, "  -  ", Len(cbo_spread.Text), vbTextCompare)

 If cbo_type.Text = "" Then cbo_type.Text = "-"
...
cc.Open "select DISTINCT(cc.cc_code),cc_desc from costcode cc,resourcecostcode rcc where cc.cc_id=rcc.rcc_id and rcc.rcc_resource='" & frm_estimatedcost.textresccode.Text & "' ", Cn, 3, 2
While Not cc.EOF
...
Dim cr As New ADODB.Recordset
            ...
            cr.Open "select DISTINCT(dresc_curcy) from resourcedetails where  dresc_code='" & frm_estimatedcost.textresccode.Text & "' and dresc_proj='" & nj(0) & "' and  dresc_year='" & frm_estimatedcost.cbo_year.Text & "' order by  dresc_curcy", Cn, 3, 2
            If Not cr.EOF Then
            cbo_curr.Text = cr(0)
            End If
cr.Close
...
Dim um As New ADODB.Recordset
            ...
            um.Open "select * from resourcemaster rm, resourcedetails rd where rm.resc_id=rd.resc_id and rm.resc_code='" & frm_estimatedcost.textresccode.Text & "' and rd.dresc_proj='" & nj(0) & "'", Cn, 3, 2
            If Not um.EOF Then
...
DTP_sd.Enabled = True
 ...
 DTP_ed.Enabled = False
 DTP_sd.Enabled = True
 DTP_ed.Value = Format(DTP_sd.Value, "dd-MM-yyyy H:mm:ss")
...
'DTP_ed.Value = Format((CDbl(frm_estimatedcost.flex_grid.TextMatrix(flex_grid.Row, 9)) + CDbl(frm_estimatedcost.flex_grid.TextMatrix(flex_grid.Row, 16)) + CDbl(DTP_sd.Value)), "dd-MM-yyyy H:mm:ss")
lbl.Visible = True
Check1.Visible = True
...
txt_unitrate.Text = frm_estimatedcost.txt_brate.Text
yy = Split(frm_estimatedcost.cbo_pproj.Text, "  -  ", Len(frm_estimatedcost.cbo_pproj.Text), vbTextCompare)
 ass = Split(frm_estimatedcost.cbo_resc.Text, "  -  ", Len(frm_estimatedcost.cbo_resc.Text), vbTextCompare)
...
aas = Split(frm_estimatedcost.cbo_resc.Text, "  -  ", Len(frm_estimatedcost.cbo_resc.Text), vbTextCompare)

 
Dim cr As New ADODB.Recordset
            If cr.State Then cr.Close
            cr.Open "select DISTINCT(dresc_curcy) from resourcedetails where  dresc_code='" & frm_estimatedcost.textresccode.Text & "' and dresc_proj='" & yy(0) & "' and  dresc_year='" & frm_estimatedcost.cbo_year.Text & "' order by  dresc_curcy", Cn, 3, 2
            If Not cr.EOF Then
            cbo_curr.Text = cr(0)
            End If
cr.Close
...
Dim um As New ADODB.Recordset
            If um.State Then um.Close
            um.Open "select * from resourcemaster rm, resourcedetails rd where rm.resc_id=rd.resc_id and rm.resc_code='" & frm_estimatedcost.textresccode.Text & "' and rd.dresc_proj='" & yy(0) & "'", Cn, 3, 2
            If Not um.EOF Then
            cbo_uom.Text = um!resc_uom
            End If
um.Close
...
If cbo_spread.Text = "NA  -  Not Applicable" Then
   ...
   txt_etqty.Text = txt_qty.Text * txt_edays.Text
   End If
   If cbo_spread.Text = "NA  -  Progress" Then
   txt_tqty.Text = txt_qty.Text
   End If
txt_Xrate_Change
End Sub

Private Sub txt_qty_Click()
On Error Resume Next
If cbo_spread.Text = "NA  -  Not Applicable" Then
        If Check1.Value = False Then
