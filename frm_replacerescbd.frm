VERSION 5.00
Begin VB.Form frm_replacerescbd 
   BackColor       =   &H00FFFFFF&
   ClientHeight    =   9285
   ClientLeft      =   60
   ClientTop       =   450
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   615
         Left            =   10080
         Picture         =   "frm_replacerescbd.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   0
         Width           =   975
   ...
   End
End
Attribute VB_Name = "frm_replacerescbd"
...
Cn.Execute "UPDATE COST SET BD_RESCCODE='" & nn4(0) & "'  WHERE BD_SPREAD='" & nn5(0) & "' AND BD_RESCCODE='" & nn6(0) & "' AND bd_costtype='B'   and bd_jobcharge='" & nn7(0) & "'"
End If
Next k
...
i = 0: j = 0
    ...
    rcd.Open "select DISTINCT(r.resc_code),r.resc_desc from resourcemaster r , cost c where c.bd_costtype='B' and r.resc_code=c.bd_resccode and bd_spread='" & nnw3(0) & "' order by r.resc_code", Cn, 3, 2
    While Not rcd.EOF
    For i = 0 To 19
