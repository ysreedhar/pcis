...
Begin VB.Form rpt_costtype 
   ...
   End
End
Attribute VB_Name = "rpt_costtype"
...
main.lbltitle.Caption = "COST TYPE CODE LIST"
Me.Top = 10
Me.Left = 10
Option1.Value = False
Option2.Value = True
...
ls.Open "select Distinct(tranx_code),tranx_desc from transactionmaster order by tranx_code", Cn, 3, 2
While Not ls.EOF
...
Dim fso As New FileSystemObject
   ...
   fs.WriteLine "    <table border=1 cellspacing=0 BORDERCOLOR=gray width=95%>"
                ...
                fs.WriteLine "           <td  ><b>COSTTYPE LIST</td>"
   ...
   fs.WriteLine "            <td Nowrap><font color=white>Costtype</td>"
