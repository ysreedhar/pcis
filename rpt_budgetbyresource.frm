...
Begin VB.Form rpt_budgetbyresource 
   BackColor       =   &H00DC7E5A&
   ClientHeight    =   9615
   ClientLeft      =   60
   ClientTop       =   450
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmd_close 
         ...
         Height          =   480
         Left            =   9960
         Picture         =   "rpt_budgetbyresource.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      Begin VB.CommandButton cmd_show 
         ...
         Height          =   480
         Left            =   8160
         Picture         =   "rpt_budgetbyresource.frx":05FF
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton cmd_print 
         ...
         Height          =   480
         Left            =   9060
         Picture         =   "rpt_budgetbyresource.frx":0C1A
         Style           =   1  'Graphical
         TabIndex        =   20
   ...
   End
End
Attribute VB_Name = "rpt_budgetbyresource"
...
fldata1.Open "select * from cost c,jobcharge j where c.bd_jobcharge=j.job_code and c.bd_costtype='B' and c.bd_resccode='" & nm(0) & "' and c.bd_projectkey='" & hk(0) & "'  and j.jobno='" & yre & "' order by j.jobno ,c.bd_jobcharge", Cn, 3, 2
stot = 0
bamt1 = 0
Dim stit As Integer
stit = 0
...
'fs.WriteLine "            <td Nowrap>" & fldata1!bd_year & "</td>"
...
Wend
            If stit <> 0 Then
                ...
                Dim st As String
                st = Mid(yre & "  -  " & yree, 1, 35)
            fs.WriteLine "        <tr bgcolor=white height=15 class=TableFont>"
            If Check2.Value = 1 Then
            fs.WriteLine "            <td  colspan=1>&nbsp;</td>"
            fs.WriteLine "            <td  colspan=8>Sub Total   " & st & "</td>"
...
ff = Split(cbo_proj.Text, "  -  ", Len(cbo_proj.Text), vbTextCompare)
                ...
                If Check2.Value = 1 Then
                        fs.WriteLine "            <td Nowrap colspan=6> " & GetCompanyName & "</td>"
                        fs.WriteLine "            <td Nowrap colspan=3> ProjectKey</td>"
                        fs.WriteLine "            <td Nowrap colspan=2 align=center> " & ff(0) & "</td>"
                        fs.WriteLine "            <td Nowrap > Resource</td>"
                                If Option4.Value = 1 Then
                                fs.WriteLine "            <td Nowrap align=center > All</td>"
                                Else
                                fs.WriteLine "            <td Nowrap align=center > SeeEndOfReport</td>"
                                End If
                Else
                        fs.WriteLine "            <td Nowrap colspan=5> " & GetCompanyName & "</td>"
                        fs.WriteLine "            <td Nowrap colspan=2> ProjectKey</td>"
                        fs.WriteLine "            <td Nowrap colspan=2 align=center> " & ff(0) & "</td>"
                        fs.WriteLine "            <td Nowrap > Resource</td>"
                          If Option4.Value = 1 Then
                          fs.WriteLine "            <td Nowrap align=center > All</td>"
                ...
                fs.WriteLine "        </tr>"
                                    ...
                                    fs.WriteLine "        <tr bgcolor=white height=20 class=TableFont>"
                                    If Check2.Value = 1 Then
                                        fs.WriteLine "            <td Nowrap colspan=6> BUDGET BY RESOURCE(L3)</td>"
                                        fs.WriteLine "            <td Nowrap colspan=3> JobNo.</td>"
                                        
                                            If Option4.Value = 1 Then
                                            fs.WriteLine "            <td Nowrap align=center colspan=2>All</td>"
                                            Else
                                            fs.WriteLine "            <td Nowrap align=center colspan=2>SeeEndOfReport</td>"
                                            End If
                                        fs.WriteLine "            <td Nowrap >CuttoffDate</td>"
                                        fs.WriteLine "            <td Nowrap align=center>" & main.DTPcutdate1.Value & "</td>"
                                    Else
                                            fs.WriteLine "            <td Nowrap colspan=5>BUDGET BY RESOURCE(L3)</td>"
                                            fs.WriteLine "            <td Nowrap colspan=2>JobNo.</td>"
                ...
                If Check2.Value = 1 Then
                        fs.WriteLine "            <td Nowrap colspan=13><font color=white>&nbsp;</td>"
                                             
                Else
                        fs.WriteLine "            <td Nowrap colspan=11><font color=white>&nbsp;</td>"
                ...
                If Check2.Value = 1 Then
                fs.WriteLine "            <td Nowrap align=right><font color=white>% WrkCmp</td>"
...
Else
fs.WriteLine "            <td colspan=9 ><font color=black>" & nm(1) & "</td>"
End If
 fs.WriteLine "        </tr>"
 End If
...
Public Sub RPTHEADINGL2(fs As Object)
        fs.WriteLine "    <table border=1 cellspacing=0 BORDERCOLOR=gray width=95%>"
                ...
                End If
                fs.WriteLine "           <td ><b>ProjectKey</td>"
                ...
                fs.WriteLine "        </tr>"
                    ...
                    fs.WriteLine "        <tr bgcolor=white  height=20 class=TableFont>"
                    If Check2.Value = 1 Then
                    fs.WriteLine "            <td colspan=6><b>BUDGET BY RESOURCE(L2)</td>"
                    Else
                    fs.WriteLine "            <td colspan=5><b>BUDGET BY RESOURCE(L2)</td>"
                    End If
                    fs.WriteLine "           <td ><b>JobNo.</td>"
                                If Option1.Value = True Then
            ...
            fs.WriteLine "            <td Nowrap colspan=2><font color=white>Resource</td>"
            If Check2.Value = 1 Then
            fs.WriteLine "            <td colspan=11 ><font color=white>Description</td>"
            Else
            fs.WriteLine "            <td colspan=9 ><font color=white>Description</td>"
            End If
