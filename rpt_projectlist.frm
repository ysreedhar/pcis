...
Begin VB.Form rpt_projectlist 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmd_close 
         ...
         Height          =   480
         Left            =   9720
         Picture         =   "rpt_projectlist.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      Begin VB.CommandButton cmd_show 
         ...
         Height          =   480
         Left            =   9240
         Picture         =   "rpt_projectlist.frx":05FF
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmd_print 
         ...
         Height          =   480
         Left            =   10080
         Picture         =   "rpt_projectlist.frx":0C1A
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   End
End
Attribute VB_Name = "rpt_projectlist"
...
main.lbltitle.Caption = "PROJECT LIST"
Me.Top = 10
Me.Left = 10
Option1.Value = False
Option2.Value = True
...
Dim fso As New FileSystemObject
   ...
   fs.WriteLine "    <table border=1 cellspacing=0 BORDERCOLOR=gray width=95%>"
                ...
                fs.WriteLine "           <td  ><b>PROJECT LIST</td>"
   ...
   fs.WriteLine "            <td Nowrap><font color=white>Title</td>"
   fs.WriteLine "            <td Nowrap><font color=white>Proj Desc</td>"
...
rs.Open "select * from projectmaster where proj_key='" & nm(0) & "' order by proj_key", Cn, 3, 2
While Not rs.EOF
fs.WriteLine "        <tr bgcolor=white height=15 class=TableFont>"
fs.WriteLine "            <td  >" & sn & "</td>"
fs.WriteLine "            <td Nowrap >" & rs!proj_key & "</td>"
If rs!proj_title = "" Then
fs.WriteLine "            <td  >&nbsp;</td>"
Else
fs.WriteLine "            <td Nowrap >" & rs!proj_title & "</td>"
End If
If rs!proj_desc = "" Then
fs.WriteLine "            <td  >&nbsp;</td>"
Else
fs.WriteLine "            <td  Nowrap>" & rs!proj_desc & "</td>"
End If
...
Dim fso As New FileSystemObject
   ...
   fs.WriteLine "        </tr><tr>  <td align=center><font size=2>PROJECT LIST</font></td>"
   fs.WriteLine "        </tr>"
   fs.WriteLine "    </table><br>"
...
fs.WriteLine "            <td  ><font color=blue>" & rs!proj_key & "</td>"
If rs!proj_title = "" Then
fs.WriteLine "            <td  ><font color=blue>&nbsp;</td>"
Else
fs.WriteLine "            <td  ><font color=blue>" & rs!proj_title & "</td>"
End If
If rs!proj_desc = "" Then
fs.WriteLine "            <td  ><font color=blue>&nbsp;</td>"
Else
fs.WriteLine "            <td  ><font color=blue>" & rs!proj_desc & "</td>"
End If
If rs!notes = "" Or IsNull(rs!notes) Then
fs.WriteLine "            <td  ><font color=blue>&nbsp;</td>"
Else
