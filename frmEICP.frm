...
Begin VB.Form frmEICP 
   ...
   End
End
Attribute VB_Name = "frmEICP"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim strProjectKey As String
...
cr2.Open "select * from resourcedetails where dresc_code='" & frm_incurredbyResource.textresccode.Text & "' and dresc_proj='" & frm_incurredbyResource.textprojkey.Text & "' and dresc_curcy='" & cbo_curr.Text & "' and dresc_year='" & frm_incurredbyResource.cbo_year.Text & "'", Cn, 3, 2
If Not cr2.EOF Then
...
Function GetProjectKey()
 intRowSel = frm_incurredbyResource.flex_grid.RowSel
strProject = frm_incurredbyResource.flex_grid.TextMatrix(intRowSel, 20) & " - " & frm_incurredbyResource.flex_grid.TextMatrix(intRowSel, 21)
lblProjectCode.Caption = strProject
End Function

Private Sub Form_Load()
'Unload frm_incurredbyResource
On Error Resume Next
Call connect
GetProjectKey
DTP_sd.Value = Format(Date, "dd-MM-yyyy H:mm:ss")
...
txt_unitrate.Text = frm_incurredbyResource.txt_brate.Text
yy = Split(strProject, " - ", Len(strProject), vbTextCompare)
...
Dim cr As New ADODB.Recordset
            ...
            cr.Open "select DISTINCT(dresc_curcy) from resourcedetails where  dresc_code='" & frm_incurredbyResource.textresccode.Text & "' and dresc_proj='" & yy(0) & "' and  dresc_year='" & frm_incurredbyResource.cbo_year.Text & "' order by  dresc_curcy", Cn, 3, 2
            If Not cr.EOF Then
            cbo_curr.Text = cr(0)
            End If
cr.Close
...
Dim um As New ADODB.Recordset
            ...
            um.Open "select * from resourcemaster rm, resourcedetails rd where rm.resc_id=rd.resc_id and rm.resc_code='" & frm_incurredbyResource.textresccode.Text & "' and rd.dresc_proj='" & yy(0) & "'", Cn, 3, 2
            If Not um.EOF Then
...
Dim cc As New ADODB.Recordset
            ...
            cc.Open "select DISTINCT(cc.cc_code),cc_desc from costcode cc,resourcecostcode rcc where cc.cc_id=rcc.rcc_id and rcc.rcc_resource='" & frm_incurredbyResource.textresccode.Text & "' ", Cn, 3, 2
            While Not cc.EOF
