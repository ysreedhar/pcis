...
Begin VB.Form rpt_spreadlist 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmd_close 
         ...
         Height          =   480
         Left            =   9600
         Picture         =   "rpt_spreadlist.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      Begin VB.CommandButton cmd_show 
         ...
         Height          =   480
         Left            =   9120
         Picture         =   "rpt_spreadlist.frx":05FF
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmd_print 
         ...
         Height          =   480
         Left            =   9960
         Picture         =   "rpt_spreadlist.frx":0C1A
         Style           =   1  'Graphical
         TabIndex        =   6
   ...
   End
End
Attribute VB_Name = "rpt_spreadlist"
...
Dim fso As New FileSystemObject
   ...
   fs.WriteLine "    <table border=1 cellspacing=0 BORDERCOLOR=GRAY width=95%>"
        ...
        fs.WriteLine "           <td  ><b>SPREAD LIST</td>"
   ...
   fs.WriteLine "            <td Nowrap><font color=white>Spread Code</td>"
   fs.WriteLine "            <td Nowrap><font color=white>Spread Desc</td>"
...
rs.Open "select * from spreadmaster where spread_code='" & nm(0) & "' order by spread_code", Cn, 3, 2
While Not rs.EOF
fs.WriteLine "        <tr bgcolor=white height=15 class=TableFont>"
fs.WriteLine "            <td  >" & sn & "</td>"
fs.WriteLine "            <td  >" & rs!spread_code & "</td>"
fs.WriteLine "            <td  >" & rs!spread_desc & "</td>"
If rs!notes = "" Then
fs.WriteLine "            <td  >&nbsp;</td>"
ElseIf rs!notes = Null Then
fs.WriteLine "            <td  >&nbsp;</td>"
Else
...
main.lbltitle.Caption = "SPREAD CODE LIST"
Me.Top = 10
Me.Left = 10
  WebBrowser.Navigate "About:Blank"
Dim sp As New ADODB.Recordset
If sp.State Then sp.Close
sp.Open "select DISTINCT(spread_code),spread_desc from spreadmaster order by spread_code", Cn, 3, 2
While Not sp.EOF
List1.AddItem sp(0) & "  -  " & sp(1)
sp.MoveNext
Wend
sp.Close
            Option1.Value = False
