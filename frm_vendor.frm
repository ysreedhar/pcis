...
vendormaster.txt_vendorcode.Text = flex_grid.TextMatrix(flex_grid.Row, 1)
vendormaster.txt_desc.Text = flex_grid.TextMatrix(flex_grid.Row, 2)
vendormaster.DTP_tdate.Value = flex_grid.TextMatrix(flex_grid.Row, 3)
 
vendormaster.Show
vendormaster.Top = 3200
vendormaster.Left = 0
vendormaster.Height = 3135
vendormaster.Width = 4785

vendormaster.txt_vendorcode.Enabled = False
...
On Error Resume Next
main.lbltitle.Caption = "RESOURCE VENDOR CODE"
Call flex_title
Call flex_data
Toolbar1.Buttons(3).Enabled = False
...
On Error Resume Next
    ...
    With flex_grid
        ...
        .TextMatrix(0, 1) = "Vendor Code"
        .ColWidth(1) = 1200
        .ColAlignment(1) = 0
        .TextMatrix(0, 2) = "Vendor Desc "
        .ColWidth(2) = 2500
        .ColAlignment(2) = 0
        .ColWidth(3) = 0
...
vendormaster.txt_vendorcode.Enabled = True
...
On Error GoTo assad
If vendormaster.txt_vendorcode.Text = "" Then
MsgBox "Enter Vendor Code"
vendormaster.txt_vendorcode.SetFocus
Exit Sub
End If
Dim sv As New ADODB.Recordset
If sv.State Then sv.Close
sv.Open "select * from vendormaster", Cn, 3, 2
sv.AddNew
 sv!vendor_code = vendormaster.txt_vendorcode.Text
 sv!vendor_desc = vendormaster.txt_desc.Text
sv!t_date = vendormaster.DTP_tdate.Value
sv!u_date = Now
sv!t_user = main.Label2.Caption
sv!notes = vendormaster.txt_notes.Text
sv.Update
sv.Close
...
md.Open "select * from vendormaster where vendor_id=" & id1, Cn, 3, 2
If Not md.EOF Then
 'md!vendor_code = vendormaster.txt_vendorcode.Text
 md!vendor_desc = vendormaster.txt_desc.Text
 md!t_date = vendormaster.DTP_tdate.Value
 md!u_date = Now
 md!t_user = main.Label2.Caption
 md!notes = vendormaster.txt_notes.Text
md.Update
md.Close
...
dlk.Open "select * from resourcemaster where resc_vendorcode='" & flex_grid.TextMatrix(flex_grid.Row, 1) & "'", Cn, 3, 2
If Not dlk.EOF Then
...
Cn.Execute "delete from vendormaster where vendor_id=" & id2
...
'''Cn.Execute "BACKUP DATABASE PCMS1 TO DISK = 'C:\PCMS1'"
'''Cn.Close
...
fldata.Open "select * from vendormaster", Cn, 3, 2
