...
Begin VB.Form rpt_othertran 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmd_close 
         ...
         Height          =   480
         Left            =   10680
         Picture         =   "rpt_othertran.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmd_show 
         ...
         Height          =   480
         Left            =   9000
         Picture         =   "rpt_othertran.frx":05FF
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmd_print 
         ...
         Height          =   480
         Left            =   9840
         Picture         =   "rpt_othertran.frx":0C1A
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   End
End
Attribute VB_Name = "rpt_othertran"
...
main.lbltitle.Caption = "TRANX ID FOR OVERHEAD - P/ITEMS LIST"
Me.Top = 10
Me.Left = 10
Option1.Value = False
Option2.Value = True
...
ls.Open "select Distinct(ot_tranx),ot_desc from othertransaction order by ot_tranx", Cn, 3, 2
While Not ls.EOF
...
rs.Open "select * from othertransaction where ot_tranx='" & nm(0) & "' order by ot_tranx", Cn, 3, 2
While Not rs.EOF
 cnt = cnt + 1 '********************************
                                If cnt >= 58 Then
...
fs.WriteLine "            <td  >" & rs!ot_tranx & "</td>"
If rs!ot_desc = "" Then
fs.WriteLine "            <td  >&nbsp;</td>"
Else
fs.WriteLine "            <td  >" & rs!ot_desc & "</td>"
End If
...
fs.WriteLine "           <td  ><b>TranX ID For Overhead & P/Items List</td>"
...
fs.WriteLine "            <td Nowrap><font color=white>TranX</td>"
