...
Begin VB.Form rpt_progressduration 
   BackColor       =   &H00DC7E5A&
   ClientHeight    =   9825
   ClientLeft      =   120
   ClientTop       =   900
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmd_close 
         ...
         Height          =   480
         Left            =   10080
         Picture         =   "rpt_progressduration.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmd_show 
         ...
         Height          =   480
         Left            =   8400
         Picture         =   "rpt_progressduration.frx":05FF
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmd_print 
         ...
         Height          =   480
         Left            =   9240
         Picture         =   "rpt_progressduration.frx":0C1A
         Style           =   1  'Graphical
         TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "rpt_progressduration"
...
rs.Open "select * from progressdurationdetails where prgs_spread_code='" & nm(0) & "' order by prgs_startdate, prgs_id desc", Cn, 3, 2
While Not rs.EOF
 cnt = cnt + 1 '********************************
                                If cnt >= 55 Then
...
Dim jcg As New ADODB.Recordset
        ...
        jcg.Open "select DISTINCT(job_desc) from jobcharge where job_code='" & rs!prgs_job_key & "' ", Cn, 3, 2
        If Not jcg.EOF Then
...
fs.WriteLine "            <td  colspan=5><font color=white>Total Duration Days</td>"
...
Public Sub RPTHEADING(fs As Object)
 fs.WriteLine "    <table border=1 cellspacing=0 BORDERCOLOR=gray width=95%>"
            ...
            fs.WriteLine "           <td colspan=2 align=center>" & cbo_job.Text & "</td>"
            fs.WriteLine "        </tr>"
            fs.WriteLine "        <tr bgcolor=white  height=15 class=TableFont>"
            fs.WriteLine "           <td colspan=4><b>Progress Duration</td>"
            fs.WriteLine "           <td colspan=1 align=center><b>ReportDate</td>"
            fs.WriteLine "           <td colspan=2 align=center>" & Format(Date, "dd/MM/yyyy") & "</td>"
            fs.WriteLine "        </tr>"
