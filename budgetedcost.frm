...
Begin VB.Form budgetedcost 
   ...
   Begin VB.Frame Fr3 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "budgetedcost.frx":0000
         ...
         TabCaption(1)   =   "Notes"
         TabPicture(1)   =   "budgetedcost.frx":001C
...
cr2.Open "select * from resourcedetails where dresc_code='" & frm_costtranx.textresccode.Text & "' and dresc_proj='" & frm_costtranx.textprojkey.Text & "' and dresc_curcy='" & cbo_curr.Text & "' and dresc_year='" & frm_costtranx.cbo_year.Text & "'", Cn, 3, 2
If Not cr2.EOF Then
...
crr2.Open "select * from resourcedetails where dresc_code='" & frm_costtranx.textresccode.Text & "' and dresc_proj='" & frm_costtranx.textprojkey.Text & "' and dresc_curcy='" & cbo_curr.Text & "' and dresc_year='" & frm_costtranx.cbo_year.Text & "'", Cn, 3, 2
...
If cbo_spread.Text <> "NA  -  Not Applicable" Then
            jch = Split(cbo_jobcharge.Text, "  -  ", Len(cbo_jobcharge.Text), vbTextCompare)
...
nh = Split(frm_costtranx.cbo_pproj.Text, "  -  ", Len(frm_costtranx.cbo_pproj.Text), vbTextCompare)
If spl(0) = "NA" Then

            cbo_jobcharge.Clear
                                Dim jc1 As New ADODB.Recordset
                                If jc1.State Then jc1.Close
                                jc1.Open "select DISTINCT(job_code),job_desc from jobcharge where job_proj_key='" & nh(0) & "' order by job_code", Cn, 3, 2
                                While Not jc1.EOF
...
Else
            ...
            cbo_jobcharge.Clear
                                Dim bd As New ADODB.Recordset
                                If bd.State Then bd.Close
                                bd.Open "select DISTINCT(b.bdgt_job_key),j.job_desc  from budgeteddurationdetails b , jobcharge j where b.bdgt_job_key=j.job_code and bdgt_spread_code='" & spl(0) & "' order by bdgt_job_key", Cn, 3, 2
                                While Not bd.EOF
                                cbo_jobcharge.AddItem bd(0) & "  -  " & bd(1)
                                bd.MoveNext
                                Wend
            bd.Close
...
txt_unitrate.Text = frm_costtranx.txt_brate.Text
nf = Split(frm_costtranx.cbo_pproj.Text, "  -  ", Len(frm_costtranx.cbo_pproj.Text), vbTextCompare)

cbo_spread.AddItem "NA  -  Not Applicable"
Dim tr As New ADODB.Recordset
            If tr.State Then tr.Close
            tr.Open "select DISTINCT(b.bdgt_spread_code),s.spread_desc  from budgeteddurationdetails b , spreadmaster s where b.bdgt_spread_code=s.spread_code  order by bdgt_spread_code", Cn, 3, 2
            While Not tr.EOF
...
Dim cr As New ADODB.Recordset
            ...
            cr.Open "select DISTINCT(dresc_curcy) from resourcedetails where  dresc_code='" & frm_costtranx.textresccode.Text & "' and dresc_proj='" & nf(0) & "' and  dresc_year='" & frm_costtranx.cbo_year.Text & "' order by  dresc_curcy", Cn, 3, 2
            If Not cr.EOF Then
            cbo_curr.Text = cr(0)
            End If
cr.Close
...
Dim um As New ADODB.Recordset
            ...
            um.Open "select * from resourcemaster rm, resourcedetails rd where rm.resc_id=rd.resc_id and rm.resc_code='" & frm_costtranx.textresccode.Text & "' and rd.dresc_proj='" & nf(0) & "'", Cn, 3, 2
            If Not um.EOF Then
...
Dim cc As New ADODB.Recordset
            ...
            cc.Open "select DISTINCT(cc.cc_code),cc_desc from costcode cc,resourcecostcode rcc where cc.cc_id=rcc.rcc_id and rcc.rcc_resource='" & frm_costtranx.textresccode.Text & "' ", Cn, 3, 2
            While Not cc.EOF
...
Wend
um1.Close
jh = Split(frm_costtranx.cbo_pproj.Text, "  -  ", Len(frm_costtranx.cbo_pproj.Text), vbTextCompare)
cbo_jobcharge.Clear
                                Dim jc5 As New ADODB.Recordset
                                If jc5.State Then jc5.Close
                                jc5.Open "select DISTINCT(job_code),job_desc from jobcharge where job_proj_key='" & jh(0) & "' order by job_code", Cn, 3, 2
                                While Not jc5.EOF
                                cbo_jobcharge.AddItem jc5(0) & "  -  " & jc5(1)
                                jc5.MoveNext
                                Wend
                                jc5.Close
