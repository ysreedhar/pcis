...
frmagent.Caption = "merlin" + " - Microsoft Character Animation Previewer"
...
'''''''    Character.Play AnimationListBox.List(AnimationListBox.ListIndex)
 ...
 Character.Speak "Welcome" & frm_login.cbo_userid.Text & ""
...
Character.Left = (frmagent.Left + 3450) / Screen.TwipsPerPixelX
Character.Top = (frmagent.Top + 900) / Screen.TwipsPerPixelY
...
If CharLoaded Then
    If frmagent.WindowState = vbMinimized Then
        Character.Hide True
    ElseIf frmagent.WindowState = vbNormal Then
        Character.Show True
    End If
End If
