...
Begin VB.Form rpt_resourcetype 
   BackColor       =   &H00DC7E5A&
   ClientHeight    =   9735
   ClientLeft      =   60
   ClientTop       =   450
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmd_close 
         ...
         Height          =   480
         Left            =   9480
         Picture         =   "rpt_resourcetype.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmd_show 
         ...
         Height          =   480
         Left            =   9000
         Picture         =   "rpt_resourcetype.frx":05FF
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmd_print 
         ...
         Height          =   480
         Left            =   9840
         Picture         =   "rpt_resourcetype.frx":0C1A
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   End
End
Attribute VB_Name = "rpt_resourcetype"
...
main.lbltitle.Caption = "RESOURCE TYPE CODE LIST"
Me.Top = 10
Me.Left = 10
Option1.Value = False
Option2.Value = True
...
ls.Open "select Distinct(r_type),r_desc from resourcetype order by r_type", Cn, 3, 2
While Not ls.EOF
...
Dim fso As New FileSystemObject
   ...
   fs.WriteLine "    <center>"
      ...
      fs.WriteLine "    <table border=1 cellspacing=0 BORDERCOLOR=gray width=95%>"
                ...
                fs.WriteLine "           <td  ><b>RESOURCETYPE LIST</td>"
...
rs.Open "select * from resourcetype where r_type='" & nm(0) & "' order by r_type", Cn, 3, 2
While Not rs.EOF
fs.WriteLine "        <tr bgcolor=white height=15 class=TableFont>"
fs.WriteLine "            <td  >" & sn & "</td>"
fs.WriteLine "            <td  >" & rs!r_type & "</td>"
If rs!r_desc = "" Then
fs.WriteLine "            <td  >&nbsp;</td>"
Else
fs.WriteLine "            <td  >" & rs!r_desc & "</td>"
End If
